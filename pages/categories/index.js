  ...
  return (
    <>
      <SEOHead
        ...
        description="Browse riddles by category — classic riddles, nature, science, history, wordplay, lateral thinking, abstract puzzles, and modern brain teasers."
        ...
        <section className="hero" style={{ padding: '3rem 0 2rem' }}>
          ...
          <div className="container--narrow">
            ...
            <p style={{ color: 'var(--cream-dim)', fontStyle: 'italic', fontSize: '1.1rem' }}>
              Every riddle belongs to a tradition. Find yours.
            </p>
          </div>
        </section>
            ...
            {cats.map(cat => (
              <Link key={cat.slug} href={`/categories/${cat.slug}`} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div>
                    <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.4rem', marginBottom: '0.4rem', color: 'var(--cream)' }}>
                      {cat.label}
                    </h2>
                    <p style={{ color: 'var(--cream-dim)', fontSize: '0.95rem', fontStyle: 'italic', margin: 0, lineHeight: 1.5 }}>
                      {cat.description}
                    </p>
                  </div>
